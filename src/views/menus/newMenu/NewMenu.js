import { CRow, CCol, CLabel, CInput, CSelect, CButton, CCard, CCardBody, CCardHeader } from "@coreui/react";
...
const JChnage = (e) =>{
    ...
    return (
      <div className="container py-5">
        ...
        <CCard>
          <CCardHeader className="bg-dark text-white">Register Form</CCardHeader>
          <CCardBody>
